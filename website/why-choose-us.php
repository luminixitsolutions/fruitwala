...
<?php
require_once __DIR__ . '/includes/why_choose_us_content.php';
$why = fruitwala_why_choose_us_load($conn);
?>
            <!-- main body start -->
            <main>
                    ...
                    <div class="breadcrumb_wrap sec_space_mid_small" style="background-image: url(assets/images/breadcrumb/bg.jpg);">
                        <div class="breadcrumb_cont text-center">
                            <div class="breadcrumb_title">
                                <h2 class="text-white"><?= fruitwala_why_choose_us_h($why, 'breadcrumb_title') ?></h2>
                            </div>
                            <ul class="list-unstyled breadcrumb_item d-flex justify-content-center align-items-center text-white">
                                ...
                                <li><i class="fas fa-chevron-right"></i>Why Choose Us</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="product_gallery">
                                    <img src="<?= fruitwala_why_choose_us_h($why, 'hero_image') ?>" alt="<?= fruitwala_why_choose_us_h($why, 'hero_image_alt') ?>" style="height: 500px;">
                                </div>
                                </div>
                                ...
                                <div class="product_section_content about_section_content">
                                    ...
                                    <div class="product_sec_sub_title d-flex align-items-center pb-2">
                                        ...
                                        <i class="far fa-circle"></i>
                                        <i class="far fa-circle"></i>
                                        <span class="ps-1"><?= fruitwala_why_choose_us_h($why, 'badge_text') ?></span>
                                    </div>

                                    <div class="product_section_title text-effect py-2">
                                        <h2><?= fruitwala_why_choose_us_heading_html($why) ?></h2>
                                    </div>

                                    <div class="product_section_subtitle position-relative">
                                        <p class="pb-0"><?= nl2br(fruitwala_why_choose_us_h($why, 'subtitle')) ?></p>
                                    </div>

                                    <div class="product_section_desc">
                                        <p><?= nl2br(fruitwala_why_choose_us_h($why, 'body_text')) ?></p>
                                    </div>

                                    <div class="product_section_btn">
                                        <a href="<?= fruitwala_why_choose_us_h($why, 'btn_url') ?>"><button type="button" class="btn custom_btn load_more_1 rounded-pill px-5 py-3 text-white">
                                            <?= fruitwala_why_choose_us_h($why, 'btn_text') ?> <i class="fas fa-long-arrow-alt-right"></i>
                                        </button></a>
                                    </div>
   ...
   <div class="product8_sec_wrap">
      <div class="container-sm">
         <div class="team_top_content text-center">
            ...
            <div class="d-flex justify-content-center align-items-center">
               <ul class="product_tabnav_4 nav nav-pills my-5" role="tablist">
                  <li class="nav-item">
                     <button class="nav-link first_btn active text-uppercase" data-bs-toggle="pill" data-bs-target="#pills-natural">
                        <img src="assets/images/services/service15.png" alt=""> 100% Fresh Fruits
                     </button>
                  </li>
                  <li class="nav-item">
                     <button class="nav-link text-uppercase" data-bs-toggle="pill" data-bs-target="#pills-handmade">
         ...
         <div class="tab-content">
            ...
            <!-- TAB 1 -->
            <div class="tab-pane fade show active" id="pills-natural">
               <div class="row mt-5">
                  <div class="col-lg-6">
            ...
            <!-- TAB 2 -->
            <div class="tab-pane fade" id="pills-handmade">
               <div class="row mt-5">
                  <div class="col-lg-6">
