 ...
 *
 * @return array<string, array{title: string, blocks: list<array{legend: string, fields: list<array{section_key: string, field_key: string, label: string, type: 'text'|'textarea'|'image_upload', hint?: string}>}>, hero_slides_ui?: bool, list_ui?: string}>
 */
        ...
        'quality' => [
            ...
            'blocks' => [
                [
                    ...
                    'fields' => [
                        ['section_key' => 'quality_wrap', 'field_key' => 'bg_image', 'label' => 'Section background image', 'type' => 'image_upload'],
                ...
                ['legend' => 'Left column — point 1', 'fields' => [
                    ...
                    ['section_key' => 'quality_l1', 'field_key' => 'image', 'label' => 'Icon image', 'type' => 'image_upload'],
                ]],
                ['legend' => 'Left — point 2', 'fields' => [
                    ...
                    ['section_key' => 'quality_l2', 'field_key' => 'image', 'label' => 'Icon image', 'type' => 'image_upload'],
                ]],
                ['legend' => 'Left — point 3', 'fields' => [
                    ...
                    ['section_key' => 'quality_l3', 'field_key' => 'image', 'label' => 'Icon image', 'type' => 'image_upload'],
                ]],
                ['legend' => 'Right — point 1', 'fields' => [
                    ...
                    ['section_key' => 'quality_r1', 'field_key' => 'image', 'label' => 'Icon image', 'type' => 'image_upload'],
                ]],
                ['legend' => 'Right — point 2', 'fields' => [
                    ...
                    ['section_key' => 'quality_r2', 'field_key' => 'image', 'label' => 'Icon image', 'type' => 'image_upload'],
                ]],
                ['legend' => 'Right — point 3', 'fields' => [
                    ...
                    ['section_key' => 'quality_r3', 'field_key' => 'image', 'label' => 'Icon image', 'type' => 'image_upload'],
                ]],
            ],
        ],
        'sale_banners' => [
        ...
        'gallery_strip' => [
            ...
            'blocks' => [
                [
                    ...
                    'fields' => [
                        ['section_key' => 'gallery_wrap', 'field_key' => 'bg_image', 'label' => 'Background image', 'type' => 'image_upload'],
                    ],
                ],
                [
                    'legend' => 'Left column',
                ...
                [
                    ...
                    'fields' => [
                        ...
                        ['section_key' => 'gallery_mid', 'field_key' => 'image', 'label' => 'Featured image', 'type' => 'image_upload'],
                    ],
                ],
            ],
        ],
        'gallery_strip_sidebar' => [
            'title' => 'Gallery strip — sidebar posts',
            'blocks' => [],
            'list_ui' => 'gallery_strip_sidebar',
        ],
        'services' => [
