...
// On page load: only auto-calculate validity when ADDING new customer (no id).
// When EDITING, keep the saved Validity from DB — do not overwrite with package calculation.
document.addEventListener('DOMContentLoaded', () => {
  const userId = document.getElementById('userid').value;
  const isEditMode = (userId && userId.trim() !== '');
