...
function category_lists(){
  ...
  success: function(data){
    ...
    function getWard(ZoneId,WardId){
      var action = "getWard";
        $.ajax({
    url:"ajax_files/ajax_dropdown.php",
    method:"POST",
    ...
    {
      $('#WardId').html(data);
        $('#WardId').val(WardId).attr("selected",true);  
    }
    });
    }
    ...
    success:function(data)
    {
      ...
      $('#Status').attr("selected","selected").val(1);
       $('#CountryId').attr("selected","selected").val(null);
        ...
        $('#WardId').val(null).attr("selected",true);
 ...
 $.ajax({  
                ...
                success:function(data){  
                 ...
                 $('#StateId').val(data.StateId).attr("selected",true); 
                  ...
                  $('#WardId').val(data.WardId).attr("selected",true); 
