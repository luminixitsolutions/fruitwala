...
if($_GET["action"]=="delete")
{
  ...
  ?>
    <script type="text/javascript">
      ...
      window.location.href="view-agent.php";
    </script>
<?php } ?>
...
<h4 class="font-weight-bold py-3 mb-0">View Partner List
  <span style="float: right;">
<a href="add-agent.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add More</a></span>
</h4>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            <?php 
            $sql = "SELECT tu.* FROM tbl_users tu WHERE tu.Roll=4 ORDER BY tu.CreatedDate DESC";
            $res = $conn->query($sql);
             ...
             <?php } ?></td>
              <td><?php echo $row['Fname']." ".$row['Lname']; ?></td>
                ...
                <td><?php echo $row['ReferCode']; ?></td>
                 <td><?php echo $row['CommisionPer']; ?></td>
