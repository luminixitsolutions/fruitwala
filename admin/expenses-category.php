...
$MainPage="Expenses";
$Page = "Expenses-Category";
?>
<!DOCTYPE html>
<html lang="en" class="default-style layout-fixed layout-navbar-fixed">
<head>
<title><?php echo $Proj_Title; ?> | Expenses Category</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">List Of Expenses Category
...
<span class="font-weight-light">Expenses Category</span>
</h5>
...
<input type="text" name="Name" class="form-control" id="Name" placeholder="Expenses Category Name" required>
...
function category_lists(){
  var action = 'view';
      $.ajax({
  type: "POST",
  url: "ajax_files/ajax_expenses_category.php",
   data:{action:action},  
  ...
  function error_toast(){
   ...
   $.growl.error({
      title:    'Error',
      message:  'Expenses Category Already Exists',
   ...
   $.growl.success({
      title:    'Success',
      message:  'New Expenses Category Added Successfully!',
      location: isRtl ? 'tl' : 'tr'
    });
  }
function update_toast(){
  ...
  $(document).ready(function() {
    ...
    $('#example').DataTable( {
      ...
      $('#add_button').click(function(){  
           $('.modal-title').html("Add <span class='font-weight-light'>Expenses Category</span>");  
           $('#action').val("Add");  
           $('#id').val('');
                ...
                success:function(data){  
                    ...
                    $('#Status').val(data.Status).attr("selected",true);  
                     ...
                     $('#action').val('Edit'); 
                       ...
                       $('#submit').text("Update");   
                       $('.insert_frm').modal('show');
                         $('.modal-title').html("Update <span class='font-weight-light'>Expenses Category</span>"); 
 ...
 //alert(id);
   swal({
            title: "Are you sure?",
            text: "You will not be able to recover this Expenses Category!",
            type: "warning",
            ...
            if (isConfirm) {
                ...
                success:function(data){
              swal("Deleted!", "Expenses Category has been deleted.", "success");
              ...
              category_lists();
                ...
                swal("Cancelled", "Expenses Category is safe :)", "error");
            }
        });
