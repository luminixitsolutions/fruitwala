...
$ZoneId = $_POST["ZoneId"];
$WardId = $_POST["WardId"];
$query = "SELECT * FROM tbl_area WHERE Name = '$Name' AND CityId='$CityId' AND ZoneId='$ZoneId' AND WardId='$WardId'";
...
$qx = "INSERT INTO tbl_area SET Name = '$Name',CountryId='1',StateId='$StateId',CityId='$CityId',ZoneId='$ZoneId',WardId='$WardId',Status='$Status'";
	$conn->query($qx);
	echo 1;
}
}
...
$ZoneId = $_POST["ZoneId"];
$WardId = $_POST["WardId"];
$query = "SELECT * FROM tbl_area WHERE Name = '$Name' AND CityId='$CityId' AND ZoneId='$ZoneId' AND WardId='$WardId' AND id != '$id'";
$result = $conn->query($query);
$row_cnt = mysqli_num_rows($result);
if($row_cnt > 0){
  echo 0;
  ...
  $query2 = "UPDATE tbl_area SET Name = '$Name',CountryId='1',StateId='$StateId',CityId='$CityId',ZoneId='$ZoneId',WardId='$WardId',Status='$Status' WHERE id = '$id'";
 	$conn->query($query2);
  echo 1;
}
}
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
          <?php 
 $srno = 1;
  $sql = "SELECT ct.Name As City,c.Name As Country,s.Name As State,tz.Name AS Zone,tw.Name AS WardNo,sb.* FROM tbl_area sb LEFT JOIN tbl_state s ON s.id=sb.StateId 
    LEFT JOIN tbl_country c ON c.id=sb.CountryId 
    LEFT JOIN tbl_city ct ON ct.id=sb.CityId 
    LEFT JOIN tbl_zone tz ON tz.id=sb.ZoneId 
    LEFT JOIN tbl_ward tw ON tw.id=sb.WardId ORDER BY sb.id DESC";
   $rx = $conn->query($sql);
           ...
           <tr>
             ...
             <td><?php echo $nx['Country']; ?></td>
              <td><?php echo $nx['State']; ?></td>
                ...
                <td><?php echo $nx['Zone']; ?></td>
                <td><?php echo $nx['WardNo']; ?></td>
