...
$Status = $_POST["Status"];
$query = "SELECT * FROM tbl_video_gallery WHERE Name = '$Name'";
...
$qx = "INSERT INTO tbl_video_gallery SET Name = '$Name',Status='$Status'";
	$conn->query($qx);
	echo 1;
}
}
...
$Name = addslashes(trim($_POST["Name"]));
$Status = $_POST["Status"];
$query = "SELECT * FROM tbl_video_gallery WHERE Name = '$Name' AND id != '$id'";
$result = $conn->query($query);
$row_cnt = mysqli_num_rows($result);
if($row_cnt > 0){
  echo 0;
  ...
  $query2 = "UPDATE tbl_video_gallery SET Name = '$Name',Status='$Status' WHERE id = '$id'";
 	$conn->query($query2);
  echo 1;
}
}
 ...
 $srno = 1;
  ...
  ?>
           <tr>
             ...
             <td><iframe width="380" height="240" src="https://www.youtube.com/embed/<?php echo $nx['Name']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
