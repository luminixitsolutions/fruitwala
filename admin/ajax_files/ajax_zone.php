...
$CityId = $_POST["CityId"];
$query = "SELECT * FROM tbl_zone WHERE Name = '$Name' AND StateId='$StateId'";
...
$qx = "INSERT INTO tbl_zone SET Name = '$Name',CountryId='1',StateId='$StateId',CityId='$CityId',Status='$Status'";
	$conn->query($qx);
	echo 1;
}
}
...
$query = "SELECT * FROM tbl_zone WHERE Name = '$Name' AND StateId='$StateId' AND id != '$id'";
$result = $conn->query($query);
$row_cnt = mysqli_num_rows($result);
if($row_cnt > 0){
  echo 0;
  ...
  $query2 = "UPDATE tbl_zone SET Name = '$Name',CountryId='1',StateId='$StateId',CityId='$CityId',Status='$Status' WHERE id = '$id'";
 	$conn->query($query2);
  echo 1;
}
}
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
          <?php 
 $srno = 1;
  $sql = "SELECT ct.Name As City,c.Name As Country,s.Name As State,sb.* FROM tbl_zone sb LEFT JOIN tbl_state s ON s.id=sb.StateId 
