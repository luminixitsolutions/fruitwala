...
$qx = "INSERT INTO tbl_departments SET Name = '$Name',Status='$Status',CreatedBy='$user_id',CreatedDate='$CreatedDate'";
	$conn->query($qx);
	echo 1;
}
}
...
if($row_cnt > 0){
  ...
  $query2 = "UPDATE tbl_departments SET Name = '$Name',Status='$Status',ModifiedBy='$user_id',ModifiedDate='$CreatedDate' WHERE id = '$id'";
 	$conn->query($query2);
  echo 1;
}
}
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
          <?php 
 $srno = 1;
  $sql = "SELECT * FROM tbl_departments ORDER BY id DESC";
   $rx = $conn->query($sql);
